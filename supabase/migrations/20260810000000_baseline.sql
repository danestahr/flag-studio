...
CREATE OR REPLACE TRIGGER "on_auth_user_updated" AFTER UPDATE OF "email", "raw_user_meta_data" ON "auth"."users" FOR EACH ROW EXECUTE FUNCTION "public"."handle_new_user"();
...
CREATE POLICY "Allow authenticated updates to prestige-orders" ON "storage"."objects" FOR UPDATE TO "authenticated" USING ((("bucket_id" = 'renders'::"text") AND (("storage"."foldername"("name"))[1] = 'prestige-orders'::"text")));



CREATE POLICY "Allow authenticated uploads to prestige-orders" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'renders'::"text") AND (("storage"."foldername"("name"))[1] = 'prestige-orders'::"text")));



CREATE POLICY "Allow public uploads" ON "storage"."objects" USING (("bucket_id" = 'flag-logos'::"text")) WITH CHECK (("bucket_id" = 'flag-logos'::"text"));
